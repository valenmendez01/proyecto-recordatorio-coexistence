...
export function CalendarWeekHeader({
  ...
  return (
    <div className="flex border-b border-divider sticky top-0 z-30 bg-content1 w-max min-w-full">
      <div className="w-[80px] md:w-[104px] flex items-center gap-1 md:gap-2 p-1.5 md:p-2 border-r border-divider shrink-0">
